...
\Config::write('api_endpoint', '54.148.142.71');

/**
 * Keys to provide a secure connection to the frontend API application
 */
\Config::write('public_key', 'KXoeYsx5$t/XnTEd/ybBCLKCd/zw8k/');
\Config::write('private_key', 'cGYtBy/V$xRuMbuM5mzJnnrmIHLqfM1');
