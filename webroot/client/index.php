            ...
            <form id="form_986884" class="appnitro"  method="post" action="/client/index.php" enctype="multipart/form-data">
                ...
                <ul >
                    ...
                    <li id="li_5" >
                        ...
                        <div>
                            <?php if($availableOperations = \Config::read('available_operations')): ?>
                    ...
                    <li id="li_6" >
                        ...
                        <div>
                            ...
                            <select id="operation" name="data[operation]" class="element text medium">
                                ...
                                <option value="<?php echo $operation; ?>" service="<?php echo $service; ?>"><?php echo $operation; ?></option>
                                <?php endforeach; ?>
                                <?php 
                                break;
                                endforeach; ?>
                        ...
                        <div style="display: none;" id="hidden_options">
                            ...
                            <?php foreach($operations as $operation => $arguments): ?>
                            <option value="<?php echo $operation; ?>" service="<?php echo $service; ?>"><?php echo $operation; ?></option>
                            <arguments operation="<?php echo $service; ?>_<?php echo $operation ?>"><?php echo json_encode($arguments); ?></arguments>
                            <?php endforeach; ?>
                            <?php endforeach; ?>
                        </div>
                    </li>
