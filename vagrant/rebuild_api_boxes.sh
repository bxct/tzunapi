...
vagrant box remove my/api_$BOX
...
packer build  -var "iso_url=./$BOX-server-amd64.iso" api_$BOX.json

#4. add the created vagrant box
echo "==> REBUILD ==> Adding Parallels box"
vagrant box add my/api_$BOX ./box/parallels/api_$BOX-nocm-0.1.0.box
