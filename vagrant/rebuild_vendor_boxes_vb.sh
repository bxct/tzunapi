...
packer build  -var "iso_url=./$BOX-server-amd64.iso" vendor_$BOX-vb.json

#4. add the created vagrant box
echo "==> REBUILD ==> Adding VirtualBox box"
vagrant box add my/vendor_$BOX ./box/virtualbox/vendor_$BOX-nocm-0.1.0.box
