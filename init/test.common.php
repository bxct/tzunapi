...
require_once FS_ROOT . FS_DS . 'init' . FS_DS . 'test.config.php';

if(is_readable(FS_ROOT . FS_DS . 'init' . FS_DS . 'test.client.config.php')) {
    require_once FS_ROOT . FS_DS . 'init' . FS_DS . 'test.client.config.php';
}
